            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="item-card flex flex-row gap-y-10 justify-between md:items-center">
                    <div class="flex flex-row items-center gap-x-3">
                        <img src="{{ Storage::url($project->thumbnail) }}" alt="{{ $project->thumbnail }}"
                    ...
                    <div class="flex flex-row items-center gap-x-3">
                        <a href="{{ route('admin.project.tools', $project) }}"
                ...
                @forelse ($project->applicants as $applicant)
                    <div class="flex flex-row justify-between items-center">
                        <div class="flex flex-row items-center gap-x-3">
                            ...
                            <div class="flex flex-col">
                                <h3 class="text-indigo-950 text-xl font-bold">{{ $applicant->freelencer->name }}</h3>
                                <p class="text-slate-500 text-sm">{{ $applicant->freelencer->occupation }}</p>
                            </div>
                        </div>
                        ...
                        @elseif ($applicant->status == 'Rejecteding')
                ...
                @empty
                    <p>Belum ada applicants yang tertarik pada projek ini.</p>
                @endforelse
